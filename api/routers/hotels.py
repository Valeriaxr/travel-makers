...
@router.post(
    '/api/trips/{trip_id}/hotels',
    response_model=HotelOut | Error
)
def create_hotel(
    hotel: HotelIn,
    trip_id: int,
...
@router.get(
    '/api/trips/{trip_id}/hotels/',
    response_model=List[HotelOut] | Error
)
def get_hotels(
    trip_id: int,
    response: Response,
...
@router.get(
    '/api/trips/{trip_id}/hotels/{hotel.id}',
    response_model=Optional[HotelOut]
)
def get_hotel(
    hotel_id: int,
    trip_id: int,
