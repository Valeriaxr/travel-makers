...
@router.post(
    "/api/trips/{trip_id}/flights",
    response_model=FlightOut | Error
)
def create_flight(
    flight: FlightIn,
    trip_id: int,
...
@router.get(
    '/api/trips/{trip_id}/flights',
    response_model=List[FlightOut] | Error
)
def get_flights(
    trip_id: int,
    response: Response,
...
@router.get(
    '/api/trips/{trip_id}/flights/{flight.id}',
    response_model=Optional[FlightOut]
)
def get_flight(
    flight_id: int,
    trip_id: int,
